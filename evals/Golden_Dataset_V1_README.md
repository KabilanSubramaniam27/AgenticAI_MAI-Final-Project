...
- These are reviewable outcome specifications, not a completed executable fixture harness. Numerical/weather facts and fictional guide facts are supplied inline. Some orchestrator cases specify validated upstream-result preconditions (such as a ten-day cited itinerary); a future runner must materialize and validate those complete inputs before executing those cases. Do not claim an executable baseline from prose setup alone.
